...
// withRouter is for being able pass the history object to createProfile action
...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    if (!loading && profile) {
      ...
      newFormData.skills = profile.skills.join(", ");
      for (const key in profile.social)
        if (newFormData.hasOwnProperty(key))
          newFormData[key] = profile.social[key];
...
export default connect(mapStateToProps, { createProfile, getCurrentProfile })(
  // gives us access to history in props
